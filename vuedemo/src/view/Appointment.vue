<template>
    <div>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="vaccinumId" label="接种疫苗"> </el-table-column>
            ...
            <el-table-column prop="status" label="接种状态"> </el-table-column>


            <el-table-column label="操作" width="150">
                <template slot-scope="scope">
                    <el-button size="mini" native-type @click="appointable(scope.row.id)">接种</el-button>
                </template>
            </el-table-column>
...
export default {
    ...
    methods: {
        ...
        appointable(appointableid) {
            request
                .get("/gec/appointment/inoculation", {
                    params: {
                        id: appointableid,
                    },
                })
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('此操作将永久删除该疫苗, 是否继续?', '提示', {
                ...
                //删除操作
                request
                    .get("/gec/appointment/delete", {
                        params: {
                            id: row.id,
                            status: row.status,
                            vaccinumId: row.vaccinumId,
                        },
                    })
                    .then((res) => {
                        if (res.ok == true) {
