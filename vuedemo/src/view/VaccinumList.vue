<template>
    <div>
            ...
            <el-dialog title="新增/修改" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item label="生产日期">
                        <el-date-picker v-model="form.createTime" align="right" type="date" placeholder="选择日期" size="large"
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="typeName" label="疫苗类型"> </el-table-column>
            <el-table-column prop="target" label="目标人群"> </el-table-column>
            <el-table-column prop="effect" label="作用"> </el-table-column>
            <el-table-column prop="advReactions" label="不良反应"> </el-table-column>
...
export default {
    ...
    created() {
        ...
        request
            ...
            .get("/gec/vaccinum-type/queryAll")
    ...
    methods: {
        ...
        save() {
            ...
            if (this.form.id == "") {
                request
                    .post("/gec/vaccinum/insert", this.form)
                    .then((res) => {
                        if (res.ok == true) {
                            this.$message({
                                type: 'success',
                ...
                request
                    .post("/gec/vaccinum/update", this.form)
                    .then((res) => {
                        if (res.ok == true) {
                            this.$message({
                                type: 'success',
